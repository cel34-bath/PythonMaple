...
from ..workwithmaple.cad.cad_tools import CAD_by_maple, first_vector_is_smaller_or_equal
from ..workwithmaple.cad.cad_tools import recurrent_project, remove_repeated
default_max_nvar = 4
...
class CADProblem():
    ...
    def create_possible_CADs(self, with_projections = True, timelimit = 3, strong_timelimit = 100):
